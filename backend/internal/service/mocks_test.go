...
type mockUserRepo struct {
	...
	findByIDsFn      func(ids []uint64) ([]model.User, error)
...
func (m *mockUserRepo) FindByIDs(ids []uint64) ([]model.User, error) {
...
// ---- mock TimeCapsuleRepository ----
type mockCapsuleRepo struct {
	createFn           func(capsule *model.TimeCapsule) error
	findByIDFn         func(id uint64) (*model.TimeCapsule, error)
	deleteFn           func(id uint64) error
	listByUserFn       func(userID uint64, offset, limit int) ([]model.TimeCapsule, error)
	countByUserFn      func(userID uint64) (int64, error)
	listByRecipientFn  func(recipientID uint64, offset, limit int) ([]model.TimeCapsule, error)
	countByRecipientFn func(recipientID uint64) (int64, error)
	unlockDueFn        func(now time.Time) ([]model.TimeCapsule, error)
	updateFn           func(capsule *model.TimeCapsule) error
}

func (m *mockCapsuleRepo) Create(capsule *model.TimeCapsule) error { return m.createFn(capsule) }
func (m *mockCapsuleRepo) FindByID(id uint64) (*model.TimeCapsule, error) {
	return m.findByIDFn(id)
}
func (m *mockCapsuleRepo) Delete(id uint64) error { return m.deleteFn(id) }
func (m *mockCapsuleRepo) ListByUserID(userID uint64, offset, limit int) ([]model.TimeCapsule, error) {
	return m.listByUserFn(userID, offset, limit)
}
func (m *mockCapsuleRepo) CountByUserID(userID uint64) (int64, error) {
	return m.countByUserFn(userID)
}
func (m *mockCapsuleRepo) ListByRecipientID(recipientID uint64, offset, limit int) ([]model.TimeCapsule, error) {
	return m.listByRecipientFn(recipientID, offset, limit)
}
func (m *mockCapsuleRepo) CountByRecipientID(recipientID uint64) (int64, error) {
	return m.countByRecipientFn(recipientID)
}
func (m *mockCapsuleRepo) UnlockDue(now time.Time) ([]model.TimeCapsule, error) {
	return m.unlockDueFn(now)
}
func (m *mockCapsuleRepo) Update(capsule *model.TimeCapsule) error { return m.updateFn(capsule) }

// ---- mock CapsuleReplyRepository ----
type mockReplyRepo struct {
	createFn          func(reply *model.CapsuleReply) error
	findByCapsuleFn   func(capsuleID uint64) (*model.CapsuleReply, error)
	listByCapsulesFn  func(capsuleIDs []uint64) ([]model.CapsuleReply, error)
	updateFn          func(reply *model.CapsuleReply) error
	deleteByCapsuleFn func(capsuleID uint64) error
}

func (m *mockReplyRepo) Create(reply *model.CapsuleReply) error { return m.createFn(reply) }
func (m *mockReplyRepo) FindByCapsuleID(capsuleID uint64) (*model.CapsuleReply, error) {
	return m.findByCapsuleFn(capsuleID)
}
func (m *mockReplyRepo) ListByCapsuleIDs(capsuleIDs []uint64) ([]model.CapsuleReply, error) {
	if m.listByCapsulesFn == nil {
		return nil, nil
	}
	return m.listByCapsulesFn(capsuleIDs)
}
func (m *mockReplyRepo) Update(reply *model.CapsuleReply) error { return m.updateFn(reply) }
func (m *mockReplyRepo) DeleteByCapsuleID(capsuleID uint64) error {
	return m.deleteByCapsuleFn(capsuleID)
}
