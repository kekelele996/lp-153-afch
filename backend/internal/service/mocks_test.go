...
func (m *mockCapsuleRepo) Create(capsule *model.TimeCapsule) error {
	if m.createFn == nil {
		return nil
	}
	return m.createFn(capsule)
}
...
func (m *mockCapsuleRepo) Update(capsule *model.TimeCapsule) error {
	if m.updateFn == nil {
		return nil
	}
	return m.updateFn(capsule)
}
